...
function Hints() {
    var config = {
        maxAllowedHints: 500,
        hintCss: "z-index:100000;font-family:terminus;font-size:8px;"
               + "color:#fff;background-color:#5c5c5c;padding:0px 1px;"
               + "position:absolute;opacity:0.9;border:solid 2px #00ee55;"
	       + "border-radius:4px;",
        hintClass: "hinting_mode_hint",
        hintClassFocus: "hinting_mode_hint_focus",
        elemBackground: "#008787",
        elemBackgroundFocus: "#ed3434",
        elemColor: "#000"
    };
