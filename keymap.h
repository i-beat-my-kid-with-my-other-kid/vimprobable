...
Key keys[] = {
    ...
    { 0,                    GDK_q,          GDK_parenleft,  quickmark,  { .s = "1" } },
    { 0,                    GDK_q,          GDK_parenright, quickmark,  { .s = "2" } },
    { 0,                    GDK_q,          GDK_braceright, quickmark,  { .s = "3" } },
    { 0,                    GDK_q,          GDK_plus,       quickmark,  { .s = "4" } },
    { 0,                    GDK_q,          GDK_braceleft,  quickmark,  { .s = "5" } },
    { 0,                    GDK_q,          GDK_bracketright, quickmark,{ .s = "6" } },
    { 0,                    GDK_q,          GDK_bracketleft, quickmark, { .s = "7" } },
    { 0,                    GDK_q,          GDK_exclam,     quickmark,  { .s = "8" } },
    { 0,                    GDK_q,          GDK_equal,      quickmark,  { .s = "9" } },
